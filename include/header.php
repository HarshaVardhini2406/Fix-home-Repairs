...
<body>
    <nav class="nav bg-dark">
        ...
        <a class="nav-link" href="reviews\index.html">Review & Ratings</a>
        <a class="nav-link" href="about.php">About</a>
        <a class="nav-link" href="project\view.php">Advertisement & Offers</a>
        ...
        <a class="nav-link" href="export mysql_data_into_pdf_code\generate_pdf.php">Generate Provider Report</a>
